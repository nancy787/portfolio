...
const SimpleVedas = () => {
  ...
  const projectData = {
    ...
    demoLink: '#',
    features: [
      'Comprehensive access to teachings from Vedas, Gita, Puranas, Ramayana, and Mahabharata',
      'Practical guidance on mindfulness, yoga, chanting, and inner healing',
      'Modern, intuitive interface to explore spiritual content',
      'User account system with personalized learning paths',
      'Integration with REST APIs for scalable data management',
      'Future-ready upgrade using Node.js and Express for backend improvements'
    ],
