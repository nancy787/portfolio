          ...
          <div>
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: '32px' }}>
              ...
              <div style={{ display: 'flex', alignItems: 'flex-start', gap: '20px' }}>
                ...
                <div>
                  <p style={{ fontSize: '16px', color: '#757575', marginBottom: '6px', margin: 0 }}>Phone</p>
                  <p style={{ fontSize: '20px', fontWeight: 500, color: '#212121', margin: 0 }}>+91 7778009733</p>
                </div>
              </div>
              ...
              <div style={{ display: 'flex', alignItems: 'flex-start', gap: '20px' }}>
                ...
                <div>
                  <p style={{ fontSize: '16px', color: '#757575', marginBottom: '6px', margin: 0 }}>Email</p>
                  <p style={{ fontSize: '20px', fontWeight: 500, color: '#212121', margin: 0 }}>nancykumari2630@gmail.com</p>
                </div>
              </div>
              ...
              <div style={{ display: 'flex', alignItems: 'flex-start', gap: '20px' }}>
                ...
                <div>
                  <p style={{ fontSize: '16px', color: '#757575', marginBottom: '6px', margin: 0 }}>Address</p>
                  <p style={{ fontSize: '20px', fontWeight: 500, color: '#212121', margin: 0 }}>Kharar Punjab 140301, India </p>
                </div>
              </div>
            </div>
          </div>
            ...
            <div>
              ...
              <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '16px', marginBottom: '16px' }}>
                <input
                  ...
                  onFocus={(e) => {
                    e.target.style.backgroundColor = '#E8EAF6';
                    e.target.style.color = '#212121';
                  }}
                  onBlur={(e) => {
                    e.target.style.backgroundColor = '#F5F5F7';
                    if (!e.target.value) e.target.style.color = '#9e9e9e';
                  }}
                />
                <input
                  type="email"
